...
describe("[Challenge] Puppet", function () {
  ...
  it("Execution", async function () {
    ...
    console.log(
      "Before Player Transaction Count : %s",
      await ethers.provider.getTransactionCount(player.address)
    );

    console.log(
      "Before Calculate Deposit Required : %s",
      await lendingPool.calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE)
    );
    ...
    console.log(
      "Player ETH Balance : %s",
      await ethers.provider.getBalance(player.address)
    );

    console.log(
      "After Calculate Deposit Required : %s",
      await lendingPool.calculateDepositRequired(POOL_INITIAL_TOKEN_BALANCE)
    );
    ...
    console.log(
      "Player Token Balance : %s",
      await token.balanceOf(player.address)
    );

    console.log(
      "After Player Transaction Count : %s",
      await ethers.provider.getTransactionCount(player.address)
    );
  });
