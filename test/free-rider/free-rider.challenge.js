...
describe("[Challenge] Free Rider", function () {
  ...
  it("Execution", async function () {
    ...
    await attacker.connect(player).startFlashSwap();
    await attacker.connect(player).nftRecovery(devsContract.address);

    console.log(
      "Marketplace's offersCounte: ",
      await marketplace.offersCount()
    );
